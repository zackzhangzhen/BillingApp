...
public class Timeline {
    ...
    public Status uploadStatus(String name, String status,File file) throws WeiboException {
    	return new Status(Weibo.client.multPartURL("pic",WeiboConfig.getValue("baseURL") + "statuses/upload.json",
                new PostParameter[]{new PostParameter("status", status)},file, true));
